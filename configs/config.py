...
# parameters just for RAFT
_C.MODEL.CORR_IMPLEMENTATION = "reg" # ["reg", "alt", "reg_cuda", "alt_cuda"]
_C.MODEL.SHARE_BACKBONE = True
_C.MODEL.CORR_LEVELS = 4
_C.MODEL.CORR_RADIUS = 4
_C.MODEL.N_DOWNSAMPLE = 2
_C.MODEL.SLOW_FAST_GRU = True
_C.MODEL.N_GRU_LAYERS = 3
_C.MODEL.HIDDEN_DIMS = [128] * 3
_C.MODEL.MIXED_PRECISION = True
_C.MODEL.TRAIN_ITERS = 22
...
_C.REAL.TESTSET =  '/cephfs/datasets/iccv_pnp/messy-table-dataset/real_data_v10_temp/'
...
_C.SOLVER.LR_STEPS = '10000,20000,30000,40000,60000,80000:2'  # the steps to decay lr: the downscale rate
_C.SOLVER.BETAS = (0.9, 0.999)
_C.SOLVER.EPOCHS = 20  # number of epochs to train
_C.SOLVER.STEPS = 50000  # number of steps to train
_C.SOLVER.BATCH_SIZE = 2  # batch size
