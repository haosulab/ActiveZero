...
# python -m torch.distributed.launch ./DispNet/train_dispnet_temporal_ir_reproj.py --config-file ./DispNet/dispnet_config.yaml --summary-freq 10 --save-freq 100 --logdir /isabella-slow/DispNet/train_1_30/debug --seed 1234 --debug
