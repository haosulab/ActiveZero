...
def train_sample(
    ...
    mask = (disp_gt < cfg.ARGS.MAX_DISP) * (
        disp_gt > 0
    ...
    if isTrain:
        ...
        with torch.no_grad():
            ...
            loss_psmnet = F.smooth_l1_loss(
                pred_disp[mask], disp_gt[mask], reduction="mean"
            )
    ...
    (
        real_img_reproj_loss,
        real_img_warped,
        real_img_reproj_mask,
    ...
    img_output_reproj = {
        "sim_reprojection": {
            ...
            "warped": sim_img_warped,
            "pred_disp": sim_pred_disp,
            "mask": sim_img_reproj_mask,
        },
        "real_reprojection": {
            "target": img_real_L_gray_scale,
            "warped": real_img_warped,
            "pred_disp": real_pred_disp,
            "mask": real_img_reproj_mask,
        },
    }
